# -*- coding: utf-8 -*-
"""
Created on Thu May  7 16:09:57 2026
...
The highlight is chages each M fraes to the entiere video.
"""
...
def Highlight(video_name, metric_name):
    ...
    output_dir = os.path.join(script_dir, "Highlight_v2")
    ...
    """ First drawn of the rectangles """
    mask = Draw(frame_height, frame_width, detect)
    ...
    while True:
        ...
        """ Updating each m frames"""
        if i % m == 0:
            pts = MagnitudeTest(video, metric[0], n)
            detect = clustering(pts, min_pts=metric[1])
...
"""Number of frames per Updating and the count of frames for update"""
n, m = 5, 20
#############################################
